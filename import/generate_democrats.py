...
body_content = "{\"query\": {\"bool\": {\"must\": [{\"range\": {\"dtInsertDT\": {\"from\": $start,\"to\": $end}}},{\"query_string\": {\"default_field\": \"strItemKeywords\",\"query\": \"democrats\"}}],\"must_not\": [],\"should\": []},\"from\": 0,\"size\": 100000,\"sort\": [],\"facets\": {}}}"
